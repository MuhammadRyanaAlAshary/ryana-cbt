                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body position-center">
                                    ...
                                    <?php if ($data_mahasiswa->status_test == 'true') { ?>
                                        <div>
                                            <p>Anda telah melakukan ujian, silakan lihat hasil ujian anda</p>
                                            <a href="<?php echo base_url('nilai/lihat-nilai') ?>">
                                                <button class="btn btn-gradient-primary">Lihat Hasil Ujian</button>
                                            </a>
                                        </div>
                                    <?php } else { ?>
                                    <a onclick="if(confirm('Apakah anda yakin ingin memulai ujian online sekarang ?')){ location.href='<?php echo base_url('ujian/halaman-test/') ?><?php echo $data_latest_soal->id_soal ?>' }">
                                        <button class="btn btn-gradient-primary">Mulai Ujian Online</button>
                                    </a>
                                    <?php } ?>
                                </div>
                            </div>
